...
case 1: // b010_v05_alloc_msiNvidia_AT_512MiB_O2_RUN2fact1-5
    ...
    for (var ii = 0; ii < 3; ++ii) {
        ...
        /*use_script*/   draw_some_graph_8_compUSM_ACTS,
        /*display_name*/ "USM device, shared, host" //computer_name + " - alloc glibc vs sycl - " + size_str + " - run " + string(current_run)
        );
        batch_add_file(
        /*graph*/       graph,
        /*in_path*/     common_path,
...
case 2: // b010_v05_alloc_msiNvidia_AT_512MiB_O2_RUN2fact1-5
    ...
    for (var ii = 0; ii < 2; ++ii) {
        ...
        /*output_path*/   common_path,
        /*output_fname*/  fname_prefix_output + "alloc-" + suff + fname_suffix_output,
        /*use_script*/   draw_some_graph_8_compUSMAccDirect_ACTS,
        /*display_name*/ "USM device, shared, host + direct access to SYCL mem" //computer_name + " - alloc glibc vs sycl - " + size_str + " - run " + string(current_run)
        );
        batch_add_file(
        /*graph*/       graph,
        /*in_path*/     common_path,
