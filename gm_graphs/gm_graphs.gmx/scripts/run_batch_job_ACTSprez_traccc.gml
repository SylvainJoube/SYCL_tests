...
output_path = common_path + "presentation_ACTS\";// + "traccc\";
...
case 1: // A_acts06_ptrVsFlat_mem20_sandor_AT_ld10_RUN1_q1
    ...
    for (var stp = 0; stp < 2; ++stp) {
        ...
        /*use_script*/    draw_some_graph_traccc_17_ACTSprez, 
        /*display_name*/  "SparseCCL - " + mem_location_to_str(mem_location) + " memory"
        );
