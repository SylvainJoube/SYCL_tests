...
output_path = common_path + "rapport\";// + "traccc\";
...
var new_surf_height = g_graph_height + g_graph_yoffset + 40; // 70
...
case 1: // A_acts06_ptrVsFlat_mem20_sandor_AT_ld10_RUN1_q1
    ...
    for (var im = 0; im < 3; ++im) {
        ...
        /*display_name*/  "ACTS : Sandor - mémoire " + mem_location_to_str(mem_location)
        );
...
case 2:
    ...
    /*display_name*/  "ACTS : Sandor - structures applaties"
    );
    batch_add_file( // gr.ptr.
    /*graph*/       graph,
    /*in_path*/     common_path,
