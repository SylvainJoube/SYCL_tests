...
output_image_name_ver = "4_brouillon" # 3_dl
...
if FLAT_ONLY:
    image_height = (image_width / 640) * 198 # ou 188
...
def draw_curve(name, color, y_list, y_median, linestyle):
    ...
    plt.plot([1, 2, 3, 4], y_median, color=color, label=name, linestyle=linestyle, linewidth=line_width)
...
def draw_tab():
    ...
    if tableau_horizontal:
        ...
        if (FLAT_ONLY):
            ...
            print("\\hline")
            print(draw_tab_item("shared", y_median_shared_flat))
            # print("\\hline")
            # print(draw_tab_item("host", y_median_host_flat))
            print("\\hline")
