...
output_image_name_ver = "5-4_brouillon" # 3_dl
...
if FLAT_ONLY:
    ...
    output_image_name = "sparseccl_onlyFlat" + output_image_name_ver + ".png"
else:
    image_height = (image_width / 640) * 258 # 273
    plt.figure(figsize=(image_width/my_dpi, image_height/my_dpi), dpi=my_dpi)
    output_image_name = "sparseccl_ptrAndFlat" + output_image_name_ver + ".png"
...
def draw_tab():
    ...
    if tableau_horizontal:
        ...
        if (FLAT_ONLY):
            ...
            print("\\hline\\hline")
            print(draw_tab_item("device", "dev", y_median_device))
            print("\\hline")
            print(draw_tab_item("accessors", "acc", y_median_acc))
            print("\\hline")
            print(draw_tab_item("shared", "sha", y_median_shared_flat))
            print("\\hline")
            print(draw_tab_item("host", "hos", y_median_host_flat))
            ...
            print(draw_tab_item("shared flat", "s\\_f", y_median_shared_flat))
            print("\\hline")
            print(draw_tab_item("shared ptr", "s\\_p", y_median_shared_ptr))
            print("\\hline")
            # print("TODO : mettre host flat ici")
            # print("\\hline")
            # Host flat à remplacer par la valeur déjà dans le papier
            print(draw_tab_item("host flat", "h\\_f", y_median_host_flat))
            print("\\hline")
            print(draw_tab_item("host ptr", "h\\_p", y_median_host_ptr))
            print("\\hline")
