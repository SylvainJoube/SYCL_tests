...
#define OUTPUT_FILE_NAME "mbf_sh_output_bench_h44.shared_txt"

static std::string ver_prefix = "mbf01_X23";
...
void generic_USM_compute(cl::sycl::queue &sycl_q, host_dataset* dataset,
    ...
    auto e = sycl_q.submit([&](cl::sycl::handler& h) {
        h.parallel_for<MyKernel>(cl::sycl::range<1>(PARALLEL_FOR_SIZE), [=](cl::sycl::id<1> chunk_index) {
